      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <div className="grid md:grid-cols-2 gap-20 items-center relative z-10">
            <div>
              <h2 className="creative-title">Let's build <span className="text-gradient">magic</span>.</h2>
              <p className="text-indigo-900/80 text-2xl mb-16 leading-relaxed font-medium">
              ...
              <div className="space-y-10">
                ...
                >
                  <motion.div 
                    ...
                    className="w-20 h-20 bg-indigo-50 rounded-[2rem] flex items-center justify-center text-indigo-600 group-hover/item:bg-indigo-600 group-hover/item:text-white transition-all duration-500 shadow-xl group-hover/item:shadow-indigo-500/30"
                  >
                    <Mail className="w-10 h-10" />
                  </motion.div>
                  <div>
                    <p className="text-xs font-black font-mono text-indigo-400 uppercase tracking-[0.3em] mb-2">Direct Line</p>
                    <p className="text-2xl font-black text-brand-heading group-hover/item:text-indigo-600 transition-colors tracking-tight">raghda.helmy82@gmail.com</p>
                  </div>
                </motion.a>
                <motion.a 
                ...
                >
                  ...
                  <div>
                    <p className="text-xs font-black font-mono text-indigo-400 uppercase tracking-[0.3em] mb-2">Network</p>
                    <p className="text-2xl font-black text-brand-heading group-hover/item:text-indigo-600 transition-colors tracking-tight">LinkedIn Profile</p>
                  </div>
                </motion.a>
              </div>
            </div>

            <div className="bg-white/60 p-12 rounded-[3rem] border border-indigo-100 flex flex-col items-center justify-center text-center relative overflow-hidden group/wa shadow-inner">
              ...
              <div className="w-28 h-28 bg-yellow-100 rounded-full flex items-center justify-center text-yellow-600 mb-10 animate-float relative z-10 shadow-lg shadow-yellow-500/10">
                <Zap className="w-14 h-14" />
              </div>
              <h3 className="text-4xl font-black mb-6 relative z-10 text-brand-heading tracking-tight">Instant Chat</h3>
              <p className="text-indigo-900/80 mb-12 text-xl font-medium relative z-10">
              ...
              <a 
                ...
                className="w-full py-6 bg-[#25D366] hover:bg-[#128C7E] text-white rounded-[2rem] font-black transition-all shadow-2xl shadow-green-500/30 flex items-center justify-center gap-5 text-2xl relative z-10 hover:scale-[1.02] active:scale-95"
              >
